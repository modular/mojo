...
[Jupyter
notebook](https://github.com/modular/mojo/tree/main/examples/notebooks#readme).
...
* If you want to experiment with some code, clone [the Mojo
  repo](https://github.com/modular/mojo/) to try our code examples:
  ...
  notebooks](https://github.com/modular/mojo/tree/main/examples/notebooks#readme)
